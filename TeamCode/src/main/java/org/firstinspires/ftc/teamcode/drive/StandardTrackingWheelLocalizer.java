...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 1.0425;
    public static double Y_MULTIPLIER = 1.1235422;

    public static double LATERAL_DISTANCE = 12.6;//12.554; // in; distance between the left and right wheels
